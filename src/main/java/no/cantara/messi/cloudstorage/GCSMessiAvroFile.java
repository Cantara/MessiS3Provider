...
class GCSMessiAvroFile implements MessiAvroFile {

    private final Storage storage;
    private final Blob blob;
    private final BlobId blobId;

    GCSMessiAvroFile(Storage storage, Blob blob) {
        this.storage = storage;
        this.blob = blob;
        this.blobId = blob.getBlobId();
    }

    GCSMessiAvroFile(Storage storage, BlobId blobId) {
        this.storage = storage;
        this.blob = null;
        this.blobId = blobId;
    }
    ...
    public long getOffsetOfLastBlock() {
        return GCSMessiUtils.getOffsetOfLastBlock(blobId);
    }
